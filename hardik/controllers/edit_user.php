                ...
                <div id="d"><br>
                    ...
                    ?>
                        ...
                        <form id="form" name="form" method="post" role="from" enctype="multipart/form-data" ><br><br>
                            ...
                            <input type="text" name="uname" value="<?php echo $edit['username'];?>" id="uname" placeholder="username" /><br>
                            
                            <label>Update Email :</label>
                            
                            <input type="text" name="mail" value="<?php echo $edit['email'];?>" id="mail" placeholder="example@example.com" /> <br>
                            
                            <label>Update FirstName :</label>

                            <input type="text" name="fname" value="<?php echo $edit['fname'];?>" id="fname" placeholder="John" /><br>
                            
                            <label>Update LastName :</label>
                        
                            <input type="text" name="lname" value="<?php echo $edit['lname'];?>" id="lname" placeholder="Woo" /> <br>
                            
                            <label>Update Addres1 :</label>
                            
                            <input type="text" name="add1" value="<?php echo $edit['add1'];?>" id="add1" placeholder="132-xyz street" /><br>
                            
                            <label>Update Addres2 :</label>

                            <input type="text" name="add2" value="<?php echo $edit['add2'];?>" id="add2" placeholder="opp.xyz road" /> <br>

                            <label>Update City :</label>

                            <input type="text" name="city" value="<?php echo $edit['city'];?>" id="city" placeholder="Newyork" /><br>
